...
def get_CIFAR10_data(num_training=40000, num_val=10000, num_test=10000, show_sample=True):
    """
    Load the CIFAR-10 dataset, and divide the sample into training set, validation set and test set
    """

    cifar10_dir = '/home/abhishek/dev/Semester_2/SMAI/Assignments/Assignment_2/Datasets/Question-1/cifar-10-python/cifar-10-batches-py/'
...
def visualize_sample(X_train, y_train, classes, samples_per_class=7):
    ...
    for y, cls in enumerate(classes):
        idxs = np.flatnonzero
        (y_train == y) # get all the indexes of cls
